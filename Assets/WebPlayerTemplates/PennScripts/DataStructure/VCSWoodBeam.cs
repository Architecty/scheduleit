...
namespace VCS
{
    //VCSWoodBeam class - subclass of VCSBuildingElement class
    //This class defines attributes and methods of a wood beam
    public class VCSWoodBeam : VCSBeam
    {
        //attributes

        //constructors
        public VCSWoodBeam() : this("", "", "", "")
        {
        }

        public VCSWoodBeam(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
