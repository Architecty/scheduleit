...
namespace VCS
{
    //VCSWindow class - subclass of VCSBuildingElement class
    //This class defines common attributes and methods of a window
    public class VCSWindow : VCSBuildingElement
    {
        //attributes

        //constructors
        public VCSWindow() : this("", "", "", "")
        {
        }

        public VCSWindow(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
