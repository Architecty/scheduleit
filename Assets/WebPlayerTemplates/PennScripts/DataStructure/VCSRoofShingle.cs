...
namespace VCS
{
    //VCSRoofShingle class - subclass of VCSRoof class
    //This class defines attributes and methods of a roof shingle
    public class VCSRoofShingle : VCSRoof
    {
        //attributes

        //constructors
        public VCSRoofShingle() : this("", "", "", "")
        {
        }

        public VCSRoofShingle(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
