...
namespace VCS
{
    public class VCSDoor : VCSBuildingElement
    {
        //VCSDoor class - subclass of VCSBuildingElement
        //This class defines a door 
        //Current version does not have any door-specific attributes yet because we don't need door attributes for the current version of VCS3D
        ...
        public VCSDoor(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
