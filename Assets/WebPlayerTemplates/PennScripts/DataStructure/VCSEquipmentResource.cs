...
namespace VCS
{
    //VCSEquipmentResource class - subclass of VCSResource
    //This class defines a equipment resource
    public class VCSEquipmentResource : VCSResource
    {
        //attributes
        private int totalOperationMinute;

        //constructors
        public VCSEquipmentResource() : this ("", "")
        {
        }

        public VCSEquipmentResource(string type) : this (type, "")
        {
        }

        public VCSEquipmentResource(string type, string name)
        {
            this.IsWorking = false;
            this.TotalOperationMinute = 0;
            this.ResourceType = type;
            this.Name = name;
        }

        //properties
        public int TotalOperationMinute
        {
            get { return totalOperationMinute; }
            set { totalOperationMinute = value; }
        }
