...
namespace VCS
{
    //VCSFloor class - subclass of VCSBuildingElement
    ...
    public class VCSFloor : VCSBuildingElement
    {
        //attributes

        //constructors
        public VCSFloor() : this("", "", "", "")
        {
        }

        public VCSFloor(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
