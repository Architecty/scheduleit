...
namespace VCS
{
    //VCSFoundation class - subclass of VCSBuildingElement
    //This class defines a foundation building element
    //current version does not have floor specific attributes, or methods
    //need to develop further when necessary
    public class VCSFoundation : VCSBuildingElement
    {
        //attributes


        //constructors
        public VCSFoundation() : this("", "", "", "")
        {
        }

        public VCSFoundation(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
