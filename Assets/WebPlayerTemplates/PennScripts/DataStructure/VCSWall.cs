...
namespace VCS
{
    //VCSWall class - subclass of VCSBuildingElement class
    //This class defines common attributes and methods of a wall
    public class VCSWall : VCSBuildingElement
    {
        //attributes
        ...
        public VCSWall(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
