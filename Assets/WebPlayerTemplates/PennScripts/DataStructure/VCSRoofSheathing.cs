...
namespace VCS
{
    //VCSRoofSheathing class - Subclass of VCSRoof
    //This class defines attributes and methods of a roof sheathing 
    public class VCSRoofSheathing : VCSRoof
    {
        //attributes
        //dimensions
        ...
        //constructors
        public VCSRoofSheathing() : this("", "", "", "")
        {

        }

        public VCSRoofSheathing(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
        ...
        //properties
        [CategoryAttribute("Roof Sheathing"), ReadOnly(true), Browsable(true), DescriptionAttribute("width value")]
        public double Width
        {
            get { return width; }
            set { width = value; }
        ...
        [CategoryAttribute("Roof Sheathing"), ReadOnly(true), Browsable(true), DescriptionAttribute("height value")]
