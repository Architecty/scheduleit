...
namespace VCS
{
    //VCSWoodBuildingElement class - subclass of VCSBuildingElement class
    //This class defines common attributes and methods of wood building elements
    public class VCSWoodBuildingElement : VCSBuildingElement
    {
        //attributes

        //constructors
        public VCSWoodBuildingElement() : this ("", "", "", "")
        {
        }

        public VCSWoodBuildingElement(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
