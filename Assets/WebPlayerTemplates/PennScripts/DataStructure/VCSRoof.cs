...
namespace VCS
{
    //VCSRoof class - Subclass of VCSBuildingElement
    //This class defines common attributes and methods of a roof  
    public class VCSRoof : VCSBuildingElement
    {
        //attributes
        ...
        public VCSRoof(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
