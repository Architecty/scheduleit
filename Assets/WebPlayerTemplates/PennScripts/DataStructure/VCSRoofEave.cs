...
namespace VCS
{
    //VCSRoofEave class - Subclass of VCSRoof
    //This class defines attributes and methods of a roof eave 
    public class VCSRoofEave : VCSRoof
    {
        //attributes

        //constructors
        public VCSRoofEave() : this("", "", "", "")
        {
        }
        
        public VCSRoofEave(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
