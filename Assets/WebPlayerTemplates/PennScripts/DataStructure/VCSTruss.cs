...
namespace VCS
{
    //VCSTruss class - subclass of VCSBuildingElement class
    //This class defines common attributes and methods of a truss element 
    public class VCSTruss : VCSBuildingElement
    {
        //attributes


        //constructors
        public VCSTruss() : this("", "", "", "")
        {
        }

        public VCSTruss(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
