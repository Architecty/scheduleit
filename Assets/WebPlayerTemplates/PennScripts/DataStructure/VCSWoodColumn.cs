...
namespace VCS
{
    //VCSWoodColumn class - subclass of VCSColumn class
    //This class defines attributes and methods of a column made of wood
    public class VCSWoodColumn : VCSColumn
    {
        //attributes

        //constructors
        public VCSWoodColumn() : this ("", "", "", "")
        {
        }

        public VCSWoodColumn(string name, string mat, string dim_str, string type)
        {
            this.Name = name;
            this.Material = mat;
